...
public class FirstPersonController : MonoBehaviour
{
   ...
   /* private void PlayFootstepSound()
    {
        // Вызов метода в зависимости от состояния персонажа и поверхности
        if (isSprinting)
        {
            footstepSoundManager.Playsprintsound();
        }
        else if (isCrouched)
        {
            footstepSoundManager.Playcrouchsound();
        }
        else
        {
            footstepSoundManager.Playstepregular();
        }
    }
    ...
    {
        footstepSoundManager.Playjumpsound();
    }

    private void PlayLandSound()
    {
        footstepSoundManager.Playlandingsound();
    }
    */
    ...
    /*
     private void Sounds()
    {
        // Пример вызова звуков при ходьбе, беге и прыжке

        if (Input.GetKeyDown(KeyCode.W) || Input.GetKeyDown(KeyCode.A) || Input.GetKeyDown(KeyCode.S) || Input.GetKeyDown(KeyCode.D))
        {
            // Запускаем звук ходьбы
            footstepSoundManager.Playstepregular();
        }
